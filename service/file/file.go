...
func (s *serviceImpl) FindAll(ctx context.Context, urlOrder, urlOrderBy string, page, limit uint64) ([]model.File, uint64, error) {
	return s.File.FindAll(ctx, urlOrder, urlOrderBy, page, limit)
}
